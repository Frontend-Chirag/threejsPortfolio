   ...
   return (
    <Tilt className='xs:w-[258px] w-full'>
      <motion.dev variants={fadeIn('right','spring',0.5 * index, 0.75)}>
        <div options={{max:50,scale:1,speed:450}}
  ...
  return (
    ...
    <motion.dev variants={textVariant()}>
     ...
     <motion.dev variants={fadeIn("","",0.1,1)} 
      ...
      '
     >
      I'm a skilled Web Developer with experience in javascript and expertise in frameworks like React, Node.js
      and little bit Three.js also. I'm quick learner and collabrate closely with clients to create efficient, scalable, and 
