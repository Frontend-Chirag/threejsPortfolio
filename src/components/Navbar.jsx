    ...
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className='w-full flex justify-between items-center max-w-7x1 mx-auto'>
          <Link to='/' className='flex items-center gap-2' onClick={() => {setActive|(''); window.scrollTo(0,0);}}>
            ...
            <p className='text-white text-[18px] font-bold cursor-pointer flex'>Chirag <span className='sm:block hidden'>&nbsp;| Portfolio</span></p>
          </Link>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          <img src={toggle ? close :menu} alt='menu' className='w-[28px] h-[28px] object-contain curson-pointer' onClick={() => setToggle(!toggle)}/>
